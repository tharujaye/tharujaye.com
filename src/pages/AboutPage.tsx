            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <AnimatedSection animation="fade-in-right">
                <div className="relative">
                  ...
                  />
                  <div className="absolute -top-6 -right-6 bg-card p-4 rounded-lg border border-border shadow-lg w-64">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 bg-primary/20 text-primary flex items-center justify-center rounded-md">
                        <svg
